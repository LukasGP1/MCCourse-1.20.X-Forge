...
import de.lulkas_.mccourse.block.entity.GemEmpoweringStationBlockEntity;
...
public class GemEmpoweringStationMenu extends AbstractContainerMenu {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.GEM_EMPOWERING_STATION.get());
    }
