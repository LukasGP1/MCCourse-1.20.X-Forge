...
public class ModBowItem extends ProjectileWeaponItem implements Vanishable {
    ...
    public ModBowItem(Properties pProperties, float arrowVelocity) {
        super(pProperties);
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        abstractarrow.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0F, f * this.arrowVelocity, 0.0F);
                        if (f == 1.0F) {
