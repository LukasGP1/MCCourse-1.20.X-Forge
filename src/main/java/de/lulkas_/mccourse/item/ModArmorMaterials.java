...
public enum ModArmorMaterials implements ArmorMaterial {
    ALEXANDRITE("alexandrite", 44, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 30, SoundEvents.ARMOR_EQUIP_NETHERITE, 5.0F, 0.9F, () -> Ingredient.of(ModItems.ALEXANDRITE.get()));
